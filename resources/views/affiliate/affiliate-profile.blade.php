                        ...
                        <div>
                            ...
                            <div class="rounded shadow px-3 py-5 bg-white">
                                       ...
                                       <div class="max-w-sm w-1/2 mb-5 bg-white rounded-lg  mx-auto border-gray-200  dark:bg-gray-800 dark:border-gray-700">
                                        <img class='rounded h-40 block mx-auto' src='{{ isset($affiliate_data[0]->profile_img)? asset('storage/'.$affiliate_data[0]->profile_img) : asset('storage/trenova_logo.jpeg')  }} ' alt='profile-image'>
                                        </div>
                                        <!--img--->
