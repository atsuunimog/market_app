<x-guest-layout>
<div class="relative">
    <img src="https://images.pexels.com/photos/8948347/pexels-photo-8948347.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260" class="absolute inset-0 object-cover w-full h-full" alt="" />
        ...
        <div class="flex flex-col items-center justify-between xl:flex-row">
          <div class="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
             ...
             the  School Marketing Platform to boost your online presence
            </h2>
          ...
          <div class="p-4 w-full max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <form method="POST" action="{{ route('school-register') }}">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="school_name" id="school_name"  :value="old('school_name')" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Enter school name" required>
                </div>
                ...
                <div class="block mt-4">
                    <a class="text-sm text-blue-600 hover:text-gray-900 font-semibold " href="{{ route('school-login') }}">
