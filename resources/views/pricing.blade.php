    ...
    <div class="relative px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div class="grid max-w-screen-md gap-10 md:grid-cols-2 sm:mx-auto">
            ...
            <ul class="mb-8 space-y-2">
              <li class="flex items-center">
                ...
                <p class="font-medium text-gray-300">
                  <i class="icon ion-checkmark-circled mr-3 text-green-400"></i>
                  Account creation with listing of school profile.</p>
              </li>
              <li class="flex items-center">
                <div class="mr-3">
                  <svg class="w-4 h-4 text-teal-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                ...
                <p class="font-medium text-gray-300">
                  <i class="icon ion-checkmark-circled mr-3 text-green-400"></i>
                  The school will be searchable on the home page</p>
              </li>
              <li class="flex items-center">
                <div class="mr-3">
                  <svg class="w-4 h-4 text-teal-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                ...
                <p class="font-medium text-gray-300">
                  <i class="icon ion-checkmark-circled mr-3 text-green-400"></i>
                  Access to the school marketplace</p>
              </li>
              <li class="flex items-center">
                <div class="mr-3">
                  <svg class="w-4 h-4 text-teal-accent-400" viewBox="0 0 24 24" stroke-linecap="round" stroke-width="2">
                ...
                <p class="font-medium text-gray-300">Ability to publish scholarship offer</p>
              </li>
            </ul>
            <button
              type="submit"
        ...
        <div>
          <div class="p-8 bg-gray-900 rounded">
            <div class="mb-4 text-center">
              <p class="text-xl font-medium tracking-wide text-white">Premium Users</p>
              <div class="flex items-center justify-center">
                <p class="mr-2 text-5xl font-semibold text-white lg:text-6xl">
                  ₦15,000
                </p>
