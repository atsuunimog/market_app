<x-guest-layout>   
    ...
    <form method="POST" action="{{ url('nominate-candidate', ['post_id' => $single_scholar_data[0]->id, 'affiliate_id' => $affiliate_code ])}}">
        @csrf
        <!-- Amount -->
      ...
      <div class="md:flex  md:w-full md:gap-5">
        ...
        <input type="hidden" name="affiliate_code" value="{{isset($affiliate_code)? $affiliate_code : null }}">
